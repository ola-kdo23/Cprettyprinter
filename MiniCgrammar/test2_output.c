...
/* Hello and welcome to the final testing stage of the C grammar I wrote where were gonna see whether or not we can get this to work for a longer and more complex project */
int main ()
{
    // testing single line comments char
    play_response;
